...
InFileName = "./results/Spermatophyta58024_plnDB_pyphlawd02072020_reformated.csv"
...
NewNameFile = "./results/Spermatophyta_clean02152020.csv"
...
#            try common_N(qqbit, spbits) == 0 or common_N(qqbit, spbits) >=2:
